...
public class CallbackTest {
    ...
    public void test() {
        ...
        driver.findElement(By.cssSelector("[type=\"text\"]")).sendKeys("Александр");     // находим первый элемент - поле ввода имени, и вводим в него имя Андрей (командой sendkeys)
        driver.findElement(By.cssSelector("[type=\"tel\"]")).sendKeys("+79807133080"); // заполняем следующее поле заявки - телефон
